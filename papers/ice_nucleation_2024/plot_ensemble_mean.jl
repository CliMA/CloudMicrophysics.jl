...
iterations = collect(1:size(ABDINM_output[5])[1])
...
ax1 = MK.Axis(ABDINM_fig[1, 1], ylabel = "m coefficient [-]", xlabel = "iteration number")
...
ax3 = MK.Axis(ABIFM_fig[1, 1], ylabel = "m coefficient [-]", xlabel = "iteration number")
