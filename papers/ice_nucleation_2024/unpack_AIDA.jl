...
function unpack_data(data_file_name, ; total_t = 0)
    ...
    elseif data_file_name == "TROPIC04"
        ...
        AIDA_act_frac_profile = interpolated_data(raw_act_frac_data, AIDA_t_profile) # activated fraction for TROPIC04
        AIDA_S_ice_profile = interpolated_data(raw_S_ice_data, AIDA_t_profile)       # S_ice for TROPIC04
