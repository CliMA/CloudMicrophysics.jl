...
Typically it is the 3rd moment of the PSD.
...
Typically those are the 3rd and the 0th moments of the PSD.
The scheme's prognostic variables are the specific content (mass fraction)
  ...
  which are proportional to the 3rd and 0th moment of the PSD.
...
The schemes are needed when using a 2-moment microphysics scheme.
