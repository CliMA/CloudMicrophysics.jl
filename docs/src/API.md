...
Microphysics1M.rain_autoconversion_threshold
...
The freeze/shed closure and how it is assembled:

```@docs
P3Scheme.PartitionedOuter
P3Scheme.SplitCorrection
P3Scheme.BulkPartition
P3Scheme.∫liquid_ice_collisions_split
```
