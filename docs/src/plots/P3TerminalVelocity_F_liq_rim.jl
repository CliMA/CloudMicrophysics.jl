...
function fig1()
    ...
    # ax1_ = make_axis(fig, 3, 1, "Particle regimes with small Dₘ")
    # hm = Plt.contourf!(
    #     ax1_,
    #     F_rims,
    #     F_liqs,
    ...
    # ax2_ = make_axis(fig, 3, 2, "Particle regimes with medium Dₘ")
    # hm = Plt.contourf!(
    #     ax2_,
    #     F_rimm,
    #     F_liqm,
    ...
    # ax3_ = make_axis(fig, 3, 3, "Particle regimes with large Dₘ")
    # hm = Plt.contourf!(
    #     ax3_,
    #     F_riml,
    #     F_liql,
    ...
    ax1 = make_axis(fig, 1, 1, "Vₘ with small Dₘ")
    hm = Plt.contourf!(
        ax1,
        F_rims,
        F_liqs,
    ...
    ax2 = make_axis(fig, 1, 2, "Vₘ with medium Dₘ")
    hm = Plt.contourf!(
        ax2,
        F_rimm,
        F_liqm,
    ...
    ax3 = make_axis(fig, 1, 3, "Vₘ with large Dₘ")
    hm = Plt.contourf!(
        ax3,
        F_riml,
        F_liql,
