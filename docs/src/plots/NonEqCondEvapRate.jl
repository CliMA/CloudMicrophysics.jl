...
include("plotting_utilities.jl")  # spliced_cmap
...
function generate_cond_evap_rate(::HydrostaticBalance_qₗ_z)
    ...
    file_name = "condensation_evaporation_$(x_suf)_$(y_suf).png"

    return (; title, xlabel, ylabel, colormap, file_name,
...
function make_figure(case)
    (; title, xlabel, ylabel, colormap, file_name,
        x, y, data, S,
