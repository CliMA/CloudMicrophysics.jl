...
function p3_relations_plot()
    ...
    # add legend
    CMK.Legend(fig[24:25, 1], [fig1_0, fig1_5, fig1_8], [CMK.L"$F_{rim} = 0.0$", CMK.L"$F_{rim} = 0.5$", CMK.L"$F_{rim} = 0.8$"], framevisible = false)
    CMK.Legend(fig[24:25, 3], [d_tha], [CMK.L"$D_{th}$"], framevisible = false)
    CMK.Legend(fig[24:25, 7], [d_cr_5, d_cr_8], [CMK.L"$D_{cr}$ for $F_{rim} = 0.5$", CMK.L"$D_{cr}$ for $F_{rim} = 0.8$"], framevisible = false)
    CMK.Legend(fig[24:25, 5], [d_gr_5, d_gr_8], [CMK.L"$D_{gr}$ for $F_{rim} = 0.5$", CMK.L"$D_{gr}$ for $F_{rim} = 0.8$"], framevisible = false)
