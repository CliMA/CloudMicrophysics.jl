...
function autoconversion_and_cloud_liquid_self_collection(
    ...
    sc = liquid_self_collection(acnv, pdf_c, q_lcl, ρ, au.dN_lcl_dt)
...
) = rain_evaporation(sb_params, air_params, tps, q.tot, q.liq - q_rai, q.ice - q_sno, q_rai, q_sno, ρ, N_rai, T)
