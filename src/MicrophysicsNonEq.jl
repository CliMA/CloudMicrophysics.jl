...
###
### Wrappers fro calling with TD.PhasePartition (Deprecated)
###
conv_q_vap_to_q_lcl_icl_MM2015(
    prs::CMP.CloudLiquid, tps::TDI.PS, q::TDI.TD.PhasePartition, q_rai, q_sno, ρ, T,
) = conv_q_vap_to_q_lcl_icl_MM2015(prs, tps, q.tot, q.liq - q_rai, q.ice - q_sno, q_rai, q_sno..., ρ, T)
