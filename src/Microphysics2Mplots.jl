...
q_liq_KK2000 = [CM2.conv_q_liq_to_q_rai_KK2000(param_set, q_liq, 1.0, 1e8) for q_liq in q_liq_range]
q_liq_B1994 = [CM2.conv_q_liq_to_q_rai_B1994(param_set, q_liq, 1e8) for q_liq in q_liq_range]
q_liq_TC1980 = [CM2.conv_q_liq_to_q_rai_TC1980(param_set, q_liq, 1e8) for q_liq in q_liq_range]
q_liq_LD2004 = [CM2.conv_q_liq_to_q_rai_LD2004(param_set, q_liq, 1e8) for q_liq in q_liq_range]
q_liq_K1969 = [CM1.conv_q_liq_to_q_rai(param_set, q_liq) for q_liq in q_liq_range]

N_d_KK2000 = [CM2.conv_q_liq_to_q_rai_KK2000(param_set, 5e-4, 1.0, N_d) for N_d in N_d_range]
N_d_B1994 = [CM2.conv_q_liq_to_q_rai_B1994(param_set, 5e-4, N_d) for N_d in N_d_range]
N_d_TC1980 = [CM2.conv_q_liq_to_q_rai_TC1980(param_set, 5e-4, N_d) for N_d in N_d_range]
N_d_LD2004 = [CM2.conv_q_liq_to_q_rai_LD2004(param_set, 5e-4, N_d) for N_d in N_d_range]
