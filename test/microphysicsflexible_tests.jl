...
function test_microphysics_flexible(FT)
    ...
    TT.@testset "Flexible microphysics - unit tests" begin
        ...
        clinfo = CMF.CLSetup{FT}(
            pdists = [CPD.LognormalPrimitiveParticleDistribution(FT(10.0), FT(1.0), FT(1.0))],
            mom = CPD.get_moments(CPD.LognormalPrimitiveParticleDistribution(FT(10.0), FT(1.0), FT(1.0))),
            NProgMoms = [3],
